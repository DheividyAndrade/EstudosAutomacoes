...
sleep(1)
# Clicar chekbox "Conversivel"
chekbox_conversivel = driver.find_element(By.ID, 'conversivelcheckbox')
chekbox_conversivel.click()
sleep(1)
# Clicar chekbox "Off-road"
chekbox_offroad = driver.find_element(By.ID, 'offroadcheckbox')
chekbox_offroad.click()
sleep(1)
